...
class SitesList: DefaultTable {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(refreshRows), name: "SiteAdded", object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(refreshRows), name: "SiteDeleted", object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(refreshRows), name: "SiteUpdated", object: nil)

        self.addLeftButtons()
    }

    func addLeftButtons() {
        self.exitBtn = UIBarButtonItem.init(image: UIImage.init(named: "icon-power-off"), style: UIBarButtonItemStyle.Plain, target: self, action: #selector(SitesList.exitView))
        //self.infoBtn = UIBarButtonItem.init(image: UIImage.init(named: "icon-info"), style: UIBarButtonItemStyle.Plain, target: self, action: #selector(SitesList.showInfo))
